 ...
 * Stable surface
 *
 * These exports are the current formal Avenra UI support contract.
 * They are the components the repository currently presents as stable for external adoption.
 */
